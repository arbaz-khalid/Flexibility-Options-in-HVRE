...
initial_soc = 50 # Initial state of charge of battery
...
def load_data(consumption_file_path: str, pv_file_path: str, consumption_start_date: str, consumption_end_date: str,
    ...
    Returns:
        pd.DataFrame: Cleaned and merged DataFrame containing both consumption and PV production data, including 'Electricity Demand (kWh)'.
    """
    ...
    # **Add 'Electricity Demand (kWh)' as a duplicate of 'Consumption_kWh'**
    merged_data['Electricity Demand (kWh)'] = merged_data['Consumption_kWh']
    logger.info("'Electricity Demand (kWh)' column added as a duplicate of 'Consumption_kWh'.")
